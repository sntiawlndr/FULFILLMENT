    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="form-group row mb-4">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="product_status1" name="product_status"
                                    class="custom-control-input product_status" value="Semua">
                                <label class="custom-control-label" for="product_status1">Semua</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="product_status2" name="product_status"
                                    class="custom-control-input product_status" value="Aktif">
                                <label class="custom-control-label" for="product_status2">Aktif</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="product_status3" name="product_status"
                                    class="custom-control-input product_status" value="Mati">
                            ...
                            <div class="tab-content" id="simpletabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        {{-- <tbody>
                                            @foreach ($data['dtl'] as $data)
                                                
                                            <tr>
                                            <td><input type="text" value="{{$data->product_id}}"></td>                               
            ...
            <div class="left-button">
                <a href="{{url('/selbrg')}}" class="btn btn-dark"
