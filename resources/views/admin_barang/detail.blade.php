                                    ...
                                    <form>
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-5 col-lg-9 col-sm-5">                                                
                                                ...
                                                <input type="hidden" class="form-control" id="seller_id" placeholder="" name="seller_id" value="{{$data['seller']->seller_id}}">
                                                @csrf
                                            </div>
                                        </div>
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area simple-tab">
                                    ...
                                    <div class="tab-content" id="simpletabContent">
                                       ...
                                       <a href="{{url('/barang')}}" class="btn btn-dark" style="float:right;margin-top: -1%;color:#fff;">Tutup</a> 
                                       </div>         
                                </div>
                            </div>
                        </div>
