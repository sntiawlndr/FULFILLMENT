        ...
        <div class="widget-content widget-content-area">
                                    ...
                                    <div class="form-group row mb-4">                            
                                            ...
                                            <div class="col-xl-5 col-lg-9 col-sm-5">
                                                <input type="email" class="form-control" id="order_email" placeholder="" name="order_email">
                                                <input type="hidden" class="form-control" id="order_id" name="order_id"  placeholder="">
                                                @csrf
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Daftar Packing</h5>
