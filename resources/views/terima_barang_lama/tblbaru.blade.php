            ...
            <div class="widget-content widget-content-area">
                <div class="form-group row mb-4">
                    ...
                    <div class="col-xl-10 col-lg-9 col-sm-10">
                        <input type="text" class="form-control" name="borrow_invoice_id" autocomplete="off" readonly=""
                            id="borrow_invoice_id">
                            {{-- value="{{$data['invoice'] ->borrow_invoice_id}}" --}}
                    </div>
                    <label href="javascript:void" for="hScan"  class="col-xl-2 col-sm-3 col-sm-2 col-form-label" id="autosave" enter-key-pressed="au
                    tosave" placeholder="To enter">Scan Barcode UID</label>
                    <div class="col-xl-10 col-lg-9 col-sm-10">
                        <input type="text" class="form-control" name="scan" autocomplete="off">
                    </div>
...
//       function autosave()  
//       {  
//            var post_oto = $('#post_oto').val();  
//            if(post_oto != '' )  
//            {  
//                 $.ajax({  
//                      url:"auto_save.php",  
//                      method:"POST",  
//                      data:{postOto:post_oto},  
//                      dataType:"text",  
