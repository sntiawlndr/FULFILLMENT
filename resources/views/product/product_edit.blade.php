                                    ...
                                    <form>
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                ...
                                                <input type="hidden" class="form-control" id="product_id" placeholder=""  value="{{$product->product_id}}">
                                                @csrf
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <textarea class="form-control" name="description" id="description">{{$product->product_description}}</textarea>
                                            </div>
                                        </div>
